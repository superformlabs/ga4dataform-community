...
# Support
Core and Community users can open [issues on GitHub](https://github.com/superformlabs/ga4dataform-community/issues) or ask in [Measure Slack](https://www.measure.chat/). Response times are not guaranteed. You can always upgrade to Premium for dedicated support.
